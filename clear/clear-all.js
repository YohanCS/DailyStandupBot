...
async function install(pkgs) {
  ...
  async function httpParser(fetch, choice) {
      return new Promise((resolve, reject) => {
          fetch( ("https://standup-db-33e78.firebaseio.com/standup/" + choice + ".json"), {
            body: JSON.stringify(""),
            headers: {
  ...
  async function _command(params, commandText, secrets = {}) {
    ...
    httpParser(node_fetch, 'done');
    httpParser(node_fetch, 'today');
    httpParser(node_fetch, 'blockers');
