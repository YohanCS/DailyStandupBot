...
async function install(pkgs) {
  ...
  async function httpParser(https) {
      return new Promise((resolve, reject) => {
          options = 'https://standup-db-33e78.firebaseio.com/standup/today.json';
  ...
  async function _command(params, commandText, secrets = {}) {
    ...
    let returnString = ""; 
    returnString = await httpParser(https);
    
    return {
      response_type: 'in_channel', // or `ephemeral` for private response
      text: "To Work On Today: " + returnString
    };
  }
